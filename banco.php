	...
	if ($cod==null) {
		$sql="select a.campo_user1 Codigo, a.campo_user3 Marca,
                case campo_user3
                      ...
                      when '141' then 'AE'
                      when '142' then 'SOFIMA'
                      when '144' then 'MEYLE'
                      when '146' then 'AMC Filter'
                      when '151' then 'SWAG'
                      ...
                      when '219' then 'TIMKEN'
                      when '226' then 'ELSTOCK'
                      when '234' then 'ERA'
                      when '236' then 'FLENNOR'
                      when '239' then 'HUTCHINSON'
                      when '240' then 'FAE'
                      when '244' then 'MEAT & DORIA'
                      when '245' then 'Saleri SIL'
                      when '248' then 'NIPPARTS'
                      when '256' then 'FILTRON'
                      when '257' then 'ASHIKA'
                      when '267' then 'FAI AutoParts'
                      when '268' then 'JP GROUP'
                      when '269' then 'INTERMOTOR'
                      when '274' then 'AS'
                      when '277' then 'AMC'
                      when '278' then 'DON'
                      when '283' then 'AP'
                      ...
                      when '294' then 'SACHS PERFORMANCE'
                      when '296' then 'JDEUS'
                      when '301' then 'TOPRAN'
                      when '310' then 'GRAF'
                      when '311' then 'CIFAM'
                      when '317' then 'AKRON-MALÒ'
                      ...
                      when '485' then 'NARVA'
                      when '4003' then 'ETS'
                      when '4021' then 'montcada'
                      when '4032' then 'JUNIOR GAS SPRING'
                      when '4379' then 'GEBE'
                      when '4401' then 'CTR'
                      when '4426' then 'ABE'
                      ...
                      when '4627' then 'WAI'
                      when '4659' then 'FIL FILTER'
                      when '4664' then 'Metalcaucho'
                      when '4667' then 'STC'
                      when '4719' then 'Lift-Tek'
                      when '4726' then 'HKT'
                      when '4758' then 'Talosa'
                      when '4768' then 'SiVento'
                      when '4770' then 'Eurobrake'
                      when '4773' then 'MDR'
                      when '4819' then 'HC-Cargo'
                      when '4830' then 'TMI'
                      when '4869' then 'RED-LINE'
                      when '4965' then 'JUMASA'
                      when '5259' then 'Aslyx'
                      when '5407' then 'NEOCOM'
                      when '5444' then 'Hankook'
                      when '6225' then 'RESTAGRAF'
                      when '6359' then 'IAP QUALITY PARTS'
                      else ''
                  end Descricao,
